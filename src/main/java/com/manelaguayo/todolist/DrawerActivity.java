...
public class DrawerActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textView= (TextView) navigationView.getHeaderView(0).findViewById(R.id.userMail);
        TextView nameLastview= (TextView) navigationView.getHeaderView(0).findViewById(R.id.nameLastname);

        nameLastview.setText(FirebaseAuth.getInstance().getCurrentUser().getDisplayName());
